...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        final private String mPrintString;
        ...
        public void run() {
        	...
        	for(int i = 1; i <= mMaxLoopIterations; i++){
        		acquire();
            	System.out.println(mPrintString + "(" + i + ")");
            	release();
        	}
         ...
         */
        private void acquire() { // acquire the semaphoreOne
            // TODO fill in here
         ...
         */
        private void release() { // release the semaphoreTwo
            // TODO fill in here
